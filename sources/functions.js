...
const products = (browser) => {
    ...
    products
        ...
        .click('@productButton')
        .waitForElementVisible('@boxedChocolates', 5000)
        .waitForElementVisible('@caramelLollipop', 5000)
        .click('@caramelLollipop')
        .waitForElementVisible('@caramelLollipopTitle', 5000)
        .click('@productButton')
        .waitForElementVisible('@boxedChocolates', 5000)
        .waitForElementVisible('@oreos', 5000)
        .click('@oreos')
        .waitForElementVisible('@oreosTitle', 5000)
        .click('@productButton')
        .waitForElementVisible('@boxedChocolates', 5000)
        .waitForElementVisible('@grandmasCaramels', 5000)
        .click('@grandmasCaramels')
        .waitForElementVisible('@grandmasCaramelsTitle', 5000)
        .click('@productButton')
        .waitForElementVisible('@boxedChocolates', 5000)
        .waitForElementVisible('@licorice', 5000)
        .click('@licorice')
        .waitForElementVisible('@licoriceTitle', 5000)
        .click('@productButton')
        .waitForElementVisible('@boxedChocolates', 5000)
        .waitForElementVisible('@websiteLogo', 5000)
        .click('@websiteLogo')
        .waitForElementVisible('@websiteLogo', 5000)
